...
class SemanticScholarPipelineEnvironmentVariables:
    ...
    SCHEDULE_INTERVAL = 'SEMANTIC_SCHOLAR_RECOMMENDATION_PIPELINE_SCHEDULE_INTERVAL'


DAG_ID = 'Semantic_Scholar_Recommendation_Data_Import_Pipeline'
...
def fetch_article_data_from_semantic_scholar_recommendation_and_load_into_bigquery_task(**_kwargs):
    fetch_article_data_from_semantic_scholar_recommendation_and_load_into_bigquery(
        get_pipeline_config()
    )
...
create_python_task(
    ...
    "fetch_article_data_from_semantic_scholar_recommendation_and_load_into_bigquery_task",
    fetch_article_data_from_semantic_scholar_recommendation_and_load_into_bigquery_task,
    retries=5
)
