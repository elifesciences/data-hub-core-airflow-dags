...
class TestIterLinkMessageThreadIds:
    ...
    #NEED TO ADD test_should_next_page_messages_if_exists_next_page_token How to do it with while loop?
...
class IterGmailHistory:
    ...
    # #NEED TO ADD test_should_next_page_history_if_exists_next_page_token How to do it with while loop?
